...
const WomenFortyOff = () => {
  const fortyOffProducts = womenProducts.filter((product) =>
    product.description.includes("40%")
  );

  return (
    <div>
      <h1 className="text-4xl font-extrabold text-center my-8 text-purple-600 animate-pulse drop-shadow-lg">
